...
class Gallery(models.Model):
    ...
    photos = models.ManyToManyField(getattr(settings, 'CUSTOM_PHOTO_MODEL', 'photologue.Photo'), related_name='galleries', verbose_name=_('photos'),
...
class AbstractBasePhoto(ImageModel):
    class Meta:
        abstract = True
