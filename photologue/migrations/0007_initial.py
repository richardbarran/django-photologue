...
class Migration(SchemaMigration):
    ...
    models = {
        'photologue.gallery': {
            ...
            'photos': ('sortedm2m.fields.SortedManyToManyField', [], {'null': 'True', 'related_name': "'galleries'", 'to': "orm['photologue.Photo']", 'blank': 'True', 'symmetrical': 'False'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'to': "orm['sites.Site']", 'blank': 'True', 'symmetrical': 'False'}),
